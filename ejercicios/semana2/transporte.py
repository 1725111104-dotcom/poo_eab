class Transporte:
  def __init__ (self, marca, modelo, color, precio, peso, numero_pasajeros, tipo_combustible,
...
transporte1 = Transporte("Mercedes", "Sprinter", "Negro", "$800,000", "3500 kg.", 4, "Diésel", 4, 
                         "Alemania")
transporte1.avanzar()
transporte1.frenar()
